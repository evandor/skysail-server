...
Find out about the idea and the concepts behind skysail link:dev[here].

=== User Documentation

Find out about the idea and the concepts behind skysail http://jenkins.twentyeleven.de/view/skysail-core/job/skysail-server.multibranch/job/release%252F0.0/Contained_Bundles/[here].
