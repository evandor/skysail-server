...
//        ConstraintViolationsResponse<?> post = (ConstraintViolationsResponse<?>) postAreaResource.post(form,
//                HTML_VARIANT);
...
//        ConstraintViolationsResponse<?> post = (ConstraintViolationsResponse<?>) postAreaResource.post(new AreaOld(),
//                JSON_VARIANT);
//        assertSingleValidationFailure(postAreaResource, post, "title", "may not be null");
//    }
//
...
//    // ConstraintViolationsResponse<?> post = (ConstraintViolationsResponse<?>)
//    // postListresource.post(form, HTML_VARIANT);
//    // assertSingleValidationFailure(postListresource, post, "", "name already
//    // exists");
//    // }
//    //
//    // @Test
...
//    // SkysailResponse<TodoList> result = postListresource.post(form,
//    // HTML_VARIANT);
//    //
...
//    // @Test
//    // public void
//    // users_first_list_becomes_default_even_if_not_flagged_as_such() {
//    // setUpSubject("user_users_first_list_becomes_default_even_if_not_flagged_as_such");
//    // form.add("name",
//    // "name_users_first_list_becomes_default_even_if_not_flagged_as_such");
//    // SkysailResponse<TodoList> result = postListresource.post(form,
//    // HTML_VARIANT);
//    //
//    // assertThat(responses.get(postListresource.getClass().getName()).getStatus(),is(Status.SUCCESS_CREATED));
...
//    // form.add("defaultList", "on");
//    // String id1 = postListresource.post(form,
//    // HTML_VARIANT).getEntity().getId();
//    //
//    // form.clear();
//    // form.add("name", "second_list_with_default_flag_toggles_first_one2");
//    // form.add("defaultList", "on");
//    // String id2 = postListresource.post(form,
//    // HTML_VARIANT).getEntity().getId();
//    //
//    // OrientVertex vertexById1 = ((List<OrientVertex>) new
//    // TodosRepository().getVertexById(TodoList.class, id1)).get(0);
//    // OrientVertex vertexById2 = ((List<OrientVertex>) new
//    // TodosRepository().getVertexById(TodoList.class, id2)).get(0);
//    //
