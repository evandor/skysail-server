...
case class LinkModel2(context: String, pathMatcher: PathMatcher[Unit]
  ...
  @BeanProperty val relation = LinkRelation.ALTERNATE
  //if (resource != null) resource.getLinkRelation() else LinkRelation.ALTERNATE
  @BeanProperty val verbs = Set()
  //if (resource != null) resource.getVerbs() else Set()
