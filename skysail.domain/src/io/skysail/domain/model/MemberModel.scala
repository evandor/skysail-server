...
case class MemberModel(symbol: reflect.runtime.universe.Symbol) {
 ...
 // require(f != null, "you must provide a non-null field to construct a FieldModel")
  ...
  override def toString() = {
    s"Name: ${symbol.toString}, Annotations: ${symbol.annotations}, ${symbol.isSynthetic}, ${symbol.typeSignature.resultType}"
  }
